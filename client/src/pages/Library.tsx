...
import { FileText, Upload, Brain, Calendar, ArrowRight, Plus, Map, Eye } from 'lucide-react';
...
export default function Library() {
  ...
  useEffect(() => {
    if (user) {
      Promise.all([fetchDocuments(), fetchMindmaps()]);
    }
  }, [user]);
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-6xl mx-auto">
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            {/* Mind Maps Tab */}
            <TabsContent value="mindmaps" className="mt-6">
              {isLoading ? (
                <div className="text-center py-12">
                  <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-primary mx-auto mb-4"></div>
                ...
                <div className="text-center py-12">
                  ...
                  <h3 className="text-xl font-semibold mb-2 lowercase">no mind maps yet</h3>
                  <p className="text-muted-foreground mb-6 max-w-md mx-auto lowercase">
                    create your first mind map to organize your thoughts and ideas visually.
                  </p>
                  <Button
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {mindmaps.map((mindmap) => (
                    <Card key={mindmap.id} className="hover:shadow-lg transition-shadow cursor-pointer group">
                      <CardHeader>
                        <div className="flex items-start justify-between">
                          <div className="flex-1 min-w-0">
                            <CardTitle className="text-lg truncate mb-2">
                          ...
                          <Map className="w-6 h-6 text-muted-foreground flex-shrink-0" />
                        </div>
                      </CardHeader>
